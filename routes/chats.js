 ...
 * @apiGroup Chats
 * 
 * @apiDescription Adds the username into the associated chatId. 
 * 
 * @apiHeader {String} authorization Valid JSON Web Token JWT
 * 
 ...
 * @apiError (400: Invalid Parameter) {String} message "Malformed parameter. username must not be null" 
